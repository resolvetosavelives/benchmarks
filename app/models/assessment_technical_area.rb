class AssessmentTechnicalArea < ApplicationRecord
  ...
  scope :jee1, Proc.new { AssessmentPublication.jee1.assessment_technical_areas }
  scope :spar_2018, Proc.new { AssessmentPublication.spar_2018.assessment_technical_areas }
