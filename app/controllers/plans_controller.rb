      ...
      if @get_started_form.valid?
        url =
            plan_goals_url(
                ...
                areas: @get_started_form.technical_area_ids.blank? ? nil : @get_started_form.technical_area_ids.join("-"),
                diseases: @get_started_form.diseases.blank? ? nil : @get_started_form.diseases.join("-")
            )
