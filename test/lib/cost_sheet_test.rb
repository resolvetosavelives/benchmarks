...
class CostSheetTest < ActiveSupport::TestCase
  test "creates a cost sheet from a plan" do
    ...
    assert_equal "1.1: Domestic legislation, laws, regulations, policy and administrative requirements are available in all relevant sectors and effectively enable compliance with the IHR", sheet[6][0].value
    ...
    assert_equal "15.3: Effective communication with communites", sheet[25][0].value
