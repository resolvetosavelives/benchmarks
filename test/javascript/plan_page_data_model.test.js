...
function new_model_for_nigeria_jee1() {
  return new PlanPageDataModel({
    ...
    plan: {
      ...
      created_at: "2020-01-06T19:15:23.678Z",
      updated_at: "2020-01-06T19:15:23.678Z",
      user_id: 1,
      country_alpha3: "NGA",
      assessment_type: 1,
    },
  ...
  describe("getExcludedActionsForIndicator", () => {
    it("returns the expected array of actions", () => {
      ...
      expect(result[0]).toEqual({
        ...
        sequence: 1,
        text:
          "Confirm that relevant legislation, laws, regulations, policy and administrative requirements cover all aspects of IHR implementation based on the risk profile.",
      })
    })
  })
