...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "rtsl_benchmarks_production"
  ...
  # this used to be conditional on ENV["RAILS_LOG_TO_STDOUT"].present? but in production
  #   mode we always want to log to STDOUT.
